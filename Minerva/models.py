...
class ResNet(torch.nn.Module, ABC):
    """Modified version of the ResNet18 network to handle multi-spectral inputs and cross-entropy."""
...
class ResNet18(ResNet):
    ...
    def __init__(self, criterion, input_shape=(12, 256, 256), n_classes: int = 8, zero_init_residual: bool = False,
                 groups: int = 1, width_per_group: int = 64, replace_stride_with_dilation=None,
                 norm_layer=None):
        super(ResNet18, self).__init__(BasicBlock, [2, 2, 2, 2], in_channels=input_shape[0], num_classes=n_classes,
